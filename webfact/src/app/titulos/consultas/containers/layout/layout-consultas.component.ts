...
@Component({
	selector: 'app-layout-consultas',
	templateUrl: './layout-consultas.component.html',
	styleUrls: ['./layout-consultas.component.scss']
})
export class LayoutConsultasComponent implements OnInit, OnDestroy, AfterViewInit {
