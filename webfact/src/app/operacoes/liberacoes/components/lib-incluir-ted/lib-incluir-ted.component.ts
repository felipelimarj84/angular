...
@Component({
	selector: 'app-lib-incluir-ted',
	templateUrl: './lib-incluir-ted.component.html',
	styleUrls: ['./lib-incluir-ted.component.scss']
})
export class LibIncluirTedComponent implements OnInit {
