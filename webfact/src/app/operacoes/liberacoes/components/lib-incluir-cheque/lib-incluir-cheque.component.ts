...
@Component({
	selector: 'app-lib-incluir-cheque',
	templateUrl: './lib-incluir-cheque.component.html',
	styleUrls: ['./lib-incluir-cheque.component.scss']
})
export class LibIncluirChequeComponent implements OnInit {
